...
namespace scene
{
    ...
    class basic_section
    {
      ...
      public:
        ...
        inline auto get_map_geometry() const -> const gfx::geometrybank_handle
    ...
    class basic_region
    {
      ...
      public:
        ...
        inline auto get_all_sections()
        -> std::array< scene::basic_section*, 250000 > const&
        {
            return m_sections;
        }
        ...
        bool is_scene( std::string const &Scenariofile ) const;

        inline auto terrain() const -> const std::unique_ptr< Terrain::Manager>&
